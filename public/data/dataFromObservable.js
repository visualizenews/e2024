data = ({
  ...
  PK: [
    ...
    },
    {
      ...
      turnout: 85.06,
      summary: "The president of Pakistan is indirectly elected by the Electoral College of Pakistan – a joint sitting of the Senate, National Assembly and Provincial Assemblies.",
      options: {
        majority: true,
  ...
  AZ: [
    {
      ...
      turnout: 76.68,
      notes: "With 54.5% of the votes reportedly counted, Ilham Aliyev was declared the winner of the election, securing over 92.1% of the vote",
      options: {
        majority: false,
        percentage: true,
        labelFilter: (d) => {
